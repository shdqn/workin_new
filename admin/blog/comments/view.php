                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                           <?php
									...
									$i = 0;
									$comments = $db->select("post_comments","","DESC");
									while($comment = $comments->fetch()){

									$post = $db->select("posts",["id"=>$comment->post_id])->fetch()->title;
                          ...
                          <tr>
                              ...
                              <td>
                                 ...
                                 <a class="btn btn-danger text-white" href="index?delete_post_comment=<?= $comment->id; ?>" onclick="if(!confirm('Are you sure you want to delete selected item.')){ return false; }">

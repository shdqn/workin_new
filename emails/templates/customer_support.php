<style type="text/css">
  ...
  .o_b-primary {
    border: 2px solid #0ec06e; }

  .o_bb-primary {
    border-bottom: 1px solid #0ec06e; }
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_pt" align="center">
                <h3 class="o_heading o_text-dark"></h3><h3 class="o_heading o_text-dark">New Notification</h3>
              </td>
            </tr>
          </tbody>
        </table>
            ...
            <tr>
              <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
                      <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right" style="vertical-align:top;">
                        <img editable="" class="o_br-max" src="<?= img_url("person-circle.png"); ?>" width="48" height="48" alt="" style="max-width: 48px; position: relative;">
                      </td>
                      <td class="o_bb-light o_text o_text-secondary o_sans o_px o_py" align="left" style="vertical-align:top;">
                        <p><strong class="o_text-dark">User: <?= $data['seller_user_name']; ?></strong>&nbsp;<span class="o_text-default o_text-xs">&nbsp; <span class="o_text-light"> •</span> <?= $data['seller_email']; ?></span></p>
    ...
    <tr>
      <td class="o_bg-light o_px-xs" align="center">
        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py" align="left">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
                      <td width="40" class="o_bg-dark o_br-l o_text-md o_text-white o_sans o_py-xs" align="right" style="vertical-align:top;">
                        <img editable="" src="<?= img_url("warning.png"); ?>" width="24" height="24" alt="" style="max-width: 24px; position: relative;" class="">
                      </td>
                      <td class="o_bg-dark o_br-r o_text-xs o_text-white o_sans o_px o_py-xs" align="left" style="vertical-align:top;"><p><strong>Information.</strong> This message has been sent from the customer support form.</p></td>
                    </tr>
                  </tbody>
                </table>
              </td>

...
<div class="table-responsive box-table mt-3">
	...
	<table class="table table-bordered">
		...
		<tbody>
            ...
            <?php
                ...
                $sel_orders = $db->select("orders",array("seller_id" => $login_seller_id,"order_status" => "cancelled"),"DESC");
			...
			<tr>
				...
				<td>
					...
					<a href="order_details?order_id=<?= $order_id; ?>">
    ...
    <?php
            ...
            if( $count_orders == 0){
                ...
                echo "<center><h3 class='pb-4 pt-4'><i class='fa fa-smile-o'></i> {$lang['selling_orders']['no_cancelled']} </h3></center>";
            }
